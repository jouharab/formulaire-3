...
<div class="container">
	<div class="row my-5">
		<div class="col">
<img src="imagesimplon\Imgs\simplon_white.svg" alt="s" id="" height= 100px>
    </div>
</div>
	<div class="row ">
		<div class="col">
<div class="list-group text-center">
  ...
  <a href="form_simple.html" class="list-group-item list-group-item-action">Formulaire simple</a>
  <a href="form_simple_bs.html" class="list-group-item list-group-item-action">Formulaire simple avec boostrap</a>
  <a href="form_upload.html" class="list-group-item list-group-item-action">Formulaire avec upload</a>
  <a href="form_upload_bs.html" class="list-group-item list-group-item-action">Formulaire avec upload et boostrap</a>
</div>
  </div>
</div>
</div>
...
<!-- <form method="post" action="php" enctype="multipart/form-data" >
	 ...
	 <button type="submit" >
		<a href="form_simple.html">formulaire simple</a> 
	</button>

	<button type="submit">
		<a href="form_simple_bs.html">formulaire simple avec boostrap</a>
	</button>

	<button type="submit">
		<a href="form_upload.html">formulaire avec upload</a>
	</button>
	
	<button type="submit">
		<a href="form_upload_bs.html">formulaire avec upload et boostrap</a>
	</button>

</form> -->

<!--
<form method="get" action="formulaires.php">
